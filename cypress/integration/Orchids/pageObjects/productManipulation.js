...
let productManipulation = function () {
  this.createNew = function (productData) {
    ...
    let elProductYear = 'input[placeholder="YEAR"]'
    let elProductSport = 'input[placeholder="SPORT"]'
    let elProductGender = 'input[placeholder="GENDER"]'
    ...
    cy.wait(500);
    actions.clickButton(elProductYear)
   cy.get('div.input-list.ng-scope div').eq(0).click()
    cy.wait(500);
    actions.clickButton(elProductSport)
      cy.get('div.input-list.ng-scope div').eq(0).click()
    cy.wait(500);
    actions.clickButton(elProductGender)
      cy.get('div.input-list.ng-scope div').eq(0).click()
